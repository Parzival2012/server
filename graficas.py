...
class zipper():
    ...
    def __init__(self):
        ...
        self.window.title("encriptadorZip9")

        self.window.geometry("778x390")
        ...
        self.labelName = tk.Label(self.window,text="NOMBRE DEL ARCHIVO ZIP:")
        ...
        self.btnCreateZip = tk.Button(self.window,text="CREAR ARCHIVO ZIP",width=73,bg="gray89",command=self.make_zip)
    ...
    def make_zip(self):
       ...
       try:
           ...
           if len(self.zip_content) >0:
               ...
               message =  messagebox.askquestion("CARPETA ZIP VACIA",'¿crear carpeta zip vacia')
    ...
    def clear_selection(self):
       ...
       for i in self.entryDirs.curselection():
           ...
           self.entreDirs.selection_clear(i)
    ...
    def file_list(self):
       ...
       if self.special_chars == True:
           ...
           messagebox.showinfo("ARCHIVOS EXCLUIDOS",''' Se ha detectado uno o mas archivos que
